...
public class ViewDataAbsenGuruActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database.child("absen").orderByChild("create_by").equalTo(emailUser).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()) {
                    ...
                    adapter = new AdapterAbsen(dataAbsen, ViewDataAbsenGuruActivity.this);
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, ViewDataAbsenGuruActivity.class);
    }
